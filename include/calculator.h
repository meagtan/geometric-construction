...
public:
    ...
    const Point *get_add(constr_num a, constr_num b);
    const Point *get_sub(constr_num a, constr_num b);
    const Point *get_mul(constr_num a, constr_num b);
    const Point *get_div(constr_num a, constr_num b);
    const Point *get_sqrt(constr_num a);
